...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationTestApp.department.delete.question">
        <Translate contentKey="jhipsterSampleApplicationTestApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
