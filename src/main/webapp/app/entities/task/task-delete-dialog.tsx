...
export const TaskDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationTestApp.task.delete.question">
        <Translate contentKey="jhipsterSampleApplicationTestApp.task.delete.question" interpolate={{ id: taskEntity.id }}>
