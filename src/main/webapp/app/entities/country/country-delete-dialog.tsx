...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationTestApp.country.delete.question">
        <Translate contentKey="jhipsterSampleApplicationTestApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
