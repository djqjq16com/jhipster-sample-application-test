  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationTestApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplicationTestApp.jobHistory.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationTestApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationTestApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationTestApp.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate('jhipsterSampleApplicationTestApp.Language.' + language)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="job"
                data-cy="job"
                label={translate('jhipsterSampleApplicationTestApp.jobHistory.job')}
                type="select"
              >
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('jhipsterSampleApplicationTestApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('jhipsterSampleApplicationTestApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
