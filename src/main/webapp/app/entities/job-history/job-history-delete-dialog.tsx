...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationTestApp.jobHistory.delete.question">
        <Translate contentKey="jhipsterSampleApplicationTestApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
