...
export const JobDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationTestApp.job.delete.question">
        <Translate contentKey="jhipsterSampleApplicationTestApp.job.delete.question" interpolate={{ id: jobEntity.id }}>
