...
export const LocationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationTestApp.location.delete.question">
        <Translate contentKey="jhipsterSampleApplicationTestApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
