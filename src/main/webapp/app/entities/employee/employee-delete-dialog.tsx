...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationTestApp.employee.delete.question">
        <Translate contentKey="jhipsterSampleApplicationTestApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
